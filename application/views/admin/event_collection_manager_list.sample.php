...
<?php include($crud_ignition_views_path . 'header.php'); ?><!-- END header -->
		...
		<div class="row-fluid">
			...
			<form method="get" class="form form-inline pull-right">
				...
				<select name="search_field" class="input-medium">
					...
					<option value="id" <?php if($search_field=='id') { echo 'selected="selected"'; } ?> >id</option><option value="date_created" <?php if($search_field=='date_created') { echo 'selected="selected"'; } ?> >date_created</option><option value="name" <?php if($search_field=='name') { echo 'selected="selected"'; } ?> >name</option><option value="public" <?php if($search_field=='public') { echo 'selected="selected"'; } ?> >public</option><option value="owner_id" <?php if($search_field=='owner_id') { echo 'selected="selected"'; } ?> >owner_id</option>				</select>
				<label>Sort</label>				
				<select name="sort_field" class="input-small">
					<option value="">Sort by ...</option>
					<option value="id" <?php if($sort_field=='id') { echo 'selected="selected"'; } ?> >id</option><option value="date_created" <?php if($sort_field=='date_created') { echo 'selected="selected"'; } ?> >date_created</option><option value="name" <?php if($sort_field=='name') { echo 'selected="selected"'; } ?> >name</option><option value="public" <?php if($sort_field=='public') { echo 'selected="selected"'; } ?> >public</option><option value="owner_id" <?php if($sort_field=='owner_id') { echo 'selected="selected"'; } ?> >owner_id</option>				</select>
		...
		<table class="table table-bordered table-striped">
			<thead>
				...
				<th>id</th><th>date_created</th><th>name</th><th>public</th><th>owner_id</th>					<td></td>
				</tr>
			</thead>
			<tbody>
				...
				<?php if($fields['id']['admin_header'] == 'on') { echo '<td>'.$item['id'].'</td>';  } ?><?php if($fields['date_created']['admin_header'] == 'on') { echo '<td>'.$item['date_created'].'</td>';  } ?><?php if($fields['name']['admin_header'] == 'on') { echo '<td>'.$item['name'].'</td>';  } ?><?php if($fields['public']['admin_header'] == 'on') { echo '<td>'.$item['public'].'</td>';  } ?><?php if($fields['owner_id']['admin_header'] == 'on') { echo '<td>'.$item['owner_id'].'</td>';  } ?>					<td>	
